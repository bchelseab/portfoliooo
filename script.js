...
function shrinker() {
    ...
    if (document.body.scrollTop > 50 || document.documentElement.scrollTop > 50) {
		...
		middot.style.margin = '0px 0px 0px -1.2vw';
		botdot.style.margin = '0px 0px 0px -1.2vw';
		nombre.style.fontSize = '3vw';
		nombre.style.lineHeight = '1vw';
		...
		middot.style.margin = '0px 0px 0px -2.1vw';
		botdot.style.margin = '0px 0px 0px -2.1vw';
		nombre.style.fontSize = '5vw';
		nombre.style.lineHeight = '2vw';
